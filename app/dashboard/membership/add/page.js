...
// app/dashboard/membership/add/page.jsx
"use client"
...
const AddMembershipPlan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to add membership plan');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Add New Membership Plan</h1>
